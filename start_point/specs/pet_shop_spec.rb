...
class TestPetShop < Minitest::Test
  ...
  def test_sell_pet_to_customer__pet_found
    ...
    # check has the pet added to customer pets array
    assert_equal(1, customer_pet_count(customer))
    # check has the pet_shop admin pet_sold added 1
    assert_equal(1, pets_sold(@pet_shop))
    # check has the customer money reduced
    assert_equal(100, customer_cash(customer))
    # check has the pet_shop cash increased
    assert_equal(1900, total_cash(@pet_shop))
    # check has the pet_shop pets array length reduced 1
    count = stock_count(@pet_shop)
